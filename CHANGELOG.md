...
- Unit tests (`tests/unit/storage_test.py`) covering interface guards, data models, POSIX helpers, role mapping, and `PostgresAdapter` logic (41 tests, all mocked — no DB required).
