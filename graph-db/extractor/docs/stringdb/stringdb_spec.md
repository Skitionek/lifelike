...
In Mycelium, we loaded only STRING annotation data for a few organisms (E. coli, Human, Yeast and Psuedomonas) for gene annoation
enrichment. The version in Mycelium was v11.0.  Currently version in string-db.org is v11.5. 

In Mycelium, db_STRING proteins are linked to genes through 'HAS_GENE' link. 
